                    ...
                    <div key={idx} className="group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1" style={{animationDelay : `${(idx + 1) * 100}ms` }}>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-start justify-between">
                                <h3 
                                    className="text-xl font-semibold group-hover:text-primary transition-colors"> {activity.title}
                                </h3>
                                <ArrowUpRight 
                            ...
                            <div className="flex flex-wrap gap-2">{activity.tags.map((tag, tagIdx) => (
                                <span 
                                    key={tagIdx} 
